  ...
  return (
    <div className="flex-grow flex flex-col w-full relative selection:bg-blue-600 selection:text-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-zinc-950/60 border-b border-zinc-800/50 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between max-w-7xl mx-auto w-full transition-all duration-300">
        <Link href="/" className="flex items-center gap-1.5 sm:gap-2 group focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden rounded-xl">
          ...
          <span className="font-extrabold text-lg sm:text-xl tracking-tight text-white group-hover:text-zinc-200 transition-colors">
            TeleStorage
          </span>
        </Link>
        <nav className="flex items-center gap-3 sm:gap-4">
          {user ? (
            <Link
              href="/dashboard"
              className="px-3 sm:px-5 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-semibold bg-zinc-900 border border-zinc-800 hover:border-zinc-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden transition-all duration-200 flex items-center gap-1.5 sm:gap-2"
            >
              Dashboard <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-zinc-400" />
            </Link>
          ) : (
            <>
              <Link href="/login" className="text-xs sm:text-sm font-semibold text-zinc-400 hover:text-zinc-200 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden transition-colors duration-200 px-2 py-1 rounded-lg">
                Masuk
              </Link>
              <Link
                href="/register"
                className="px-3 sm:px-5 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-md shadow-blue-600/10 hover:shadow-blue-500/20 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden transition-all duration-200"
              >
      ...
      <main className="flex-grow">
        <section className="max-w-6xl mx-auto px-6 pt-16 pb-20 text-center relative">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs font-semibold text-blue-400 mb-8 motion-safe:animate-pulse">
            <Zap className="w-3.5 h-3.5" /> Generasi Baru Cloud Storage SaaS
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6 max-w-4xl mx-auto text-white text-balance">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed text-pretty">
            Rasakan kecepatan tinggi, keamanan maksimal, dan kapasitas tak terbatas dengan mengintegrasikan Telegram Cloud langsung ke platform storage modern.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href={user ? "/dashboard" : "/register"}
              className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-xl shadow-blue-500/20 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 group"
            >
            ...
            <a
              href="#pricing"
              className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-semibold bg-zinc-900 hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden transition-all duration-200"
            >
              Lihat Paket Harga
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-8 rounded-3xl bg-zinc-900/40 border border-zinc-800 flex flex-col justify-between hover:border-zinc-700 transition-all duration-200">
              <div>
                ...
                <h3 className="text-4xl font-extrabold mt-2 mb-4">Rp0 <span className="text-sm font-normal text-zinc-400">/ selamanya</span></h3>
                ...
                <ul className="flex flex-col gap-3 text-sm text-zinc-300">
                  ...
                  <li className="flex items-center gap-2 text-zinc-400/50 line-through">
                    × Kategori & Tag Kustom
                  </li>
                </ul>
              </div>
              <Link
                href={user ? "/dashboard" : "/register"}
                className="w-full mt-8 py-3 rounded-xl font-bold bg-zinc-800 hover:bg-zinc-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden transition-all duration-200 text-center block text-sm"
              >
                Mulai Gratis
              </Link>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-b from-blue-950/20 to-zinc-900/40 border-2 border-blue-500 relative flex flex-col justify-between shadow-2xl shadow-blue-500/5 hover:border-blue-400 transition-all duration-200">
              ...
              <div>
                ...
                <h3 className="text-4xl font-extrabold mt-2 mb-4">Rp49.000 <span className="text-sm font-normal text-zinc-400">/ bulan</span></h3>
                <p className="text-zinc-400 text-sm mb-6">
              ...
              <Link
                href={user ? "/dashboard" : "/register"}
                className="w-full mt-8 py-3 rounded-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 focus:outline-hidden text-white shadow-lg shadow-blue-500/20 text-center block text-sm"
              >
                Langganan Sekarang
              </Link>
            </div>
      ...
      <footer className="bg-zinc-950 border-t border-zinc-900 py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4 text-xs text-zinc-400">
            <span className="cursor-pointer hover:text-zinc-200 transition-colors">Syarat & Ketentuan</span>
            <span className="cursor-pointer hover:text-zinc-200 transition-colors">Kebijakan Privasi</span>
          </div>
        </div>
      </footer>
    </div>
